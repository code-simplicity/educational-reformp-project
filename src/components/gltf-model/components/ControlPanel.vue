		...
		<div class="panel-header" @click="togglePanel">
			...
			<div class="header-actions">
				...
				<el-icon class="toggle-icon">
					<ArrowDown v-if="showPanel" /><ArrowRight v-else />
				</el-icon>
			</div>
		</div>
		...
		<div class="panel-content" v-show="showPanel">
			...
			<div class="control-group">
				...
				<div class="control-actions">
					...
					>
					<el-checkbox
						v-model="localAntiAlias"
						@change="onAntialiasToggle"
						size="small"
						>抗锯齿</el-checkbox
					>
				</div>
			...
			<div class="control-group">
				...
				<div class="view-buttons">
					<el-button-group>
						<el-button size="small" @click="onViewChange('front')"
							>正视图</el-button
						>
						<el-button size="small" @click="onViewChange('top')"
							>俯视图</el-button
						>
						<el-button size="small" @click="onViewChange('side')"
							>侧视图</el-button
						>
				...
				<div class="control-actions">
					<el-checkbox
						v-model="localAutoRotate"
						@change="onAutoRotateToggle"
						size="small"
						>自动旋转</el-checkbox
					>
			...
			<div class="control-group">
				...
				<div v-if="measureMode" class="measure-result">
					<span
						>测量结果:
						{{
							measureResult ? measureResult.toFixed(2) + ' 单位' : '请选择两点'
						}}</span
					>
				</div>
				...
				<div class="section-content">
					...
					<div class="camera-info" v-if="cameraInfo">
						...
						<div class="info-section">
							...
							<div class="info-value">
								X: {{ cameraInfo.target.x.toFixed(2) }}, Y:
								{{ cameraInfo.target.y.toFixed(2) }}, Z:
						...
						<div class="button-row">
							<el-button
								size="small"
								type="primary"
								@click="$emit('copy-camera-position')"
							>
								复制位置信息
							</el-button>
						</div>
			...
			<div class="panel-section full-screen-section">
				...
				>
					<div class="button-content">
						<el-icon
							><FullScreen v-if="!isFullScreen" /><Close v-else
						/></el-icon>
